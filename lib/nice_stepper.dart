...
import 'package:nice_stepper/button_step.dart';
import 'package:nice_stepper/step.dart';

class NiceStepper extends StatefulWidget {
  final List<Step> steps;
  StepperConfig? config;
  NiceStepper({required this.steps, Key? key, this.config}) : super(key: key) {
...
class _StepperState extends State<NiceStepper> with SingleTickerProviderStateMixin {
  int currentPage = 0;
  int totalPage = 0;
  double totalWidth = 0;
